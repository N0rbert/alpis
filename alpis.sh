...
apt-get install -y rpm-build libssl-devel libcurl-devel libxml2-devel libcairo-devel gcc gcc-c++ libfribidi-devel libtiff-devel libjpeg-devel libgit2-devel libwebp-devel R-tcltk cmake
